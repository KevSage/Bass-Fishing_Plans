...
with_node \
  ...
  --target "/Users/kevinsage/Bass_Fishing_Plans/mobile/ios/Pods/Target Support Files/Pods-BassClarity/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-keep-awake" "expo-secure-store" "expo-web-browser"
