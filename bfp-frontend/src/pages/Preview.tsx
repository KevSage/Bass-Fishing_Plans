...
// Split modal design - form left, search right
...
export function PreviewEnhanced() {
  ...
  useEffect(() => {
    ...
    map.current.on("click", async (e) => {
      ...
      if (waterFeature) {
        ...
        setWaterName(""); // Clear for user to type
        ...
        // Get suggested name for placeholder
        try {
  ...
  return (
    <div style={{ position: "relative", height: "100vh" }}>
      ...
      {/* Search Button (only when modal closed) */}
      {!showModal && (
        <button
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    style={{
                      width: "100%",
                      padding: "12px 16px",
                      background: isSignedIn ? "rgba(0,0,0,0.05)" : "#fff",
                      border: "1px solid rgba(0,0,0,0.2)",
                      borderRadius: 8,
                      color: "#000",
                      fontSize: "1rem",
                ...
                <button
                  ...
                  disabled={!waterName || !email || !selectedCoords}
              ...
              >
                ...
                <div className="light-search-wrapper">
                  <style>{`
                    /* Force light theme for LocationSearch in modal */
