  ...
  return (
    <div className="stats-page">
      ...
      <style>{`
        ...
        .stats-modal-content { width: 100%; max-width: 380px; max-height: 70vh; background: rgba(20,20,25,0.95); border-radius: 24px; border: 1px solid rgba(255,255,255,0.1); overflow: hidden; display: flex; flex-direction: column; }
      `}</style>
    </div>
  );
}
