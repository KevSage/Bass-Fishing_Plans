      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <Link to="/subscribe" style={smallCta}>
              $10/mo • Start Trial
            </Link>
          </div>
        </div>
        ...
        <div className="container" style={container(1100)}>
          <div style={{ textAlign: "center", position: "relative", zIndex: 1 }}>
            ...
            <p style={{ ...leadStyle, maxWidth: 980 }}>
              Bass Clarity keeps the important numbers visible — like temperature
              and wind speed — but explains what they mean in plain language so
              the day feels understandable instead of overwhelming.
            </p>
      ...
      >
        <div className="container" style={container(1200)}>
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <div style={{ marginTop: 12, opacity: 0.62, fontSize: "0.95rem" }}>
              $10/month • 5-day free trial • Cancel anytime
            </div>
          </div>
        </div>
      </section>
          ...
          >
            <div style={{ ...softCard, padding: 20 }}>
              ...
              <div style={{ marginTop: 14 }}>
                <Link to="/technique-clarity" style={smallCta}>
                  Go to Technique Clarity →
                </Link>
              </div>
            </div>

            <div style={{ ...card, padding: 20, background: "rgba(255,255,255,0.02)" }}>
              <div style={{ fontWeight: 780, marginBottom: 10 }}>
                Strategic Clarity
              </div>
              <div style={{ opacity: 0.78, lineHeight: 1.7 }}>
                Targets, retrieves, and day progression — the parts that make the
                plan executable on the water.
              </div>
              <div style={{ marginTop: 14 }}>
