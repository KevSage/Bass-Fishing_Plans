...
export function CloudIcon({ size = 24, color = 'currentColor', className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
export function WindIcon({ size = 24, color = 'currentColor', className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
export function ThermometerIcon({ size = 24, color = 'currentColor', className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
// Lure Type Icons
export function CrankbaitIcon({ size = 24, color = 'currentColor', className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={color} className={className}>
      <ellipse cx="12" cy="12" rx="8" ry="5" opacity="0.8" />
      <path d="M4 12 L2 10 M20 12 L22 14" stroke={color} strokeWidth="2" strokeLinecap="round" />
      <circle cx="9" cy="11" r="1.5" fill="#fff" />
    </svg>
  );
}

export function JigIcon({ size = 24, color = 'currentColor', className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={color} className={className}>
      <circle cx="12" cy="8" r="4" />
      <path d="M12 12 L8 20 M12 12 L16 20 M12 12 L10 22 M12 12 L14 22" 
            stroke={color} strokeWidth="2" strokeLinecap="round" opacity="0.6" />
    </svg>
  );
}

export function SpinnerbaitIcon({ size = 24, color = 'currentColor', className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
      <circle cx="18" cy="6" r="3" fill="#FFD700" opacity="0.8" />
      <path d="M18 9 L12 12" stroke={color} strokeWidth="2" />
      <path d="M12 12 L8 20 M12 12 L16 20" stroke={color} strokeWidth="2" strokeLinecap="round" />
      <circle cx="12" cy="12" r="2" fill={color} />
    </svg>
  );
}

export function FrogIcon({ size = 24, color = 'currentColor', className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={color} className={className}>
      <ellipse cx="12" cy="12" rx="6" ry="4" />
      <circle cx="9" cy="10" r="1.5" fill="#fff" />
      <circle cx="15" cy="10" r="1.5" fill="#fff" />
      <path d="M6 12 L4 14 M18 12 L20 14" stroke={color} strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}

export function SoftPlasticIcon({ size = 24, color = 'currentColor', className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
      <path d="M12 4 Q16 8 12 12 Q8 16 12 20" 
            stroke={color} strokeWidth="3" strokeLinecap="round" fill={color} fillOpacity="0.3" />
    </svg>
  );
}
...
export function FishIcon({ size = 24, color = 'currentColor', className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={color} fillOpacity="0.8" className={className}>
      <path d="M2 12 Q4 8 10 10 Q14 11 18 12 Q22 13 22 12 Q22 11 18 12 Q14 13 10 14 Q4 16 2 12 Z" />
      <circle cx="16" cy="11" r="1" fill="#fff" />
      <path d="M22 12 L24 10 M22 12 L24 14" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
