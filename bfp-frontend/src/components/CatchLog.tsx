  ...
  return (
    <>
      ...
      <style>{` 
        ...
        .catch-done-btn { border: none; background: transparent; color: #4A90E2; font-weight: 600; font-size: 0.85rem; padding: 6px 10px; border-radius: 10px; cursor: pointer; transition: all 0.2s; min-width: 60px; text-align: right; }
        .catch-done-btn:hover { background: rgba(74,144,226,0.1); }
